  ...
  function Agenda() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.renderDay = function (day, events, dayKey) {
      ...
      events = events.filter(function (e) {
        return (0, _eventLevels.inRange)(e, _dates2.default.startOf(day, 'day'), _dates2.default.endOf(day, 'day'), accessors);
      });
      ...
      return events.map(function (event, idx) {
        ...
        var first = idx === 0 ? _react2.default.createElement(
          ...
          AgendaDate ? _react2.default.createElement(AgendaDate, { day: day, label: dateLabel }) : dateLabel
        ) : false;
      ...
      if (!accessors.allDay(event)) {
        if (_dates2.default.eq(start, end, 'day')) {
          label = localizer.format({ start: start, end: end }, 'agendaTimeRangeFormat');
