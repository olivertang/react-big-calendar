...
var Calendar = function (_React$Component) {
    ...
    return {
      ...
      getters: {
        eventProp: function eventProp() {
          return eventPropGetter && eventPropGetter.apply(undefined, arguments) || {};
        },
        slotProp: function slotProp() {
          return slotPropGetter && slotPropGetter.apply(undefined, arguments) || {};
        },
        dayProp: function dayProp() {
          return dayPropGetter && dayPropGetter.apply(undefined, arguments) || {};
        }
      },
      components: (0, _defaults2.default)(components[view] || {}, (0, _omit2.default)(components, names), {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        _1 = _props.formats,
        _2 = _props.messages,
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'style', 'className', 'elementProps', 'date', 'getNow', 'length', 'showMultiDayTimes', 'components', 'formats', 'messages']);
