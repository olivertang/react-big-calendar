      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          levels.map(function (segs, idx) {
            return _react2.default.createElement(_EventRow2.default, _extends({ key: idx, segments: segs }, eventRowProps));
          }),
          !!extra.length && _react2.default.createElement(_EventEndingRow2.default, _extends({
            segments: extra,
