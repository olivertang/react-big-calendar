...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderEvents = function () {
    ...
    return styledEvents.map(function (_ref, idx) {
      ...
      if (startsBeforeDay && startsAfterDay) label = messages.allDay;else label = localizer.format({ start: start, end: end }, format);
      ...
      return _react2.default.createElement(_TimeGridEvent2.default, (_React$createElement = {
        style: style,
        event: event,
        label: label,
        key: 'evt_' + idx,
  ...
  this._selectable = function () {
    ...
    var selectionState = function selectionState(point) {
      var currentSlot = _this2.slotMetrics.closestSlotFromPoint(point, (0, _Selection.getBoundsForNode)(node));
