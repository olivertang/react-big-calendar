...
var EventCell = function (_React$Component) {
  ...
  EventCell.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['style', 'className', 'event', 'selected', 'isAllDay', 'onSelect', 'onDoubleClick', 'localizer', 'continuesPrior', 'continuesAfter', 'accessors', 'getters', 'children', 'components']);
    ...
    var showAsAllDay = isAllDay || allDay || _dates2.default.diff(start, _dates2.default.ceil(end, 'day'), 'day') > 1;
    ...
    var content = _react2.default.createElement(
      ...
      Event ? _react2.default.createElement(Event, {
        event: event,
        title: title,
        isAllDay: allDay,
        localizer: localizer
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _extends({}, props, {
          ...
          className: (0, _classnames2.default)('rbc-event', className, userProps.className, {
