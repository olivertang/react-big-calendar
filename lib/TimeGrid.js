    ...
    return this.resources.map(function (_ref, i) {
      ...
      return range.map(function (date, jj) {
        var daysEvents = (groupedEvents.get(id) || []).filter(function (event) {
          return _dates2.default.inRange(date, accessors.start(event), accessors.end(event), 'day');
        });
  ...
  TimeGrid.prototype.render = function render() {
    ...
    events.forEach(function (event) {
      if ((0, _eventLevels.inRange)(event, start, end, accessors)) {
        ...
        if (accessors.allDay(event) || _dates2.default.isJustDate(eStart) && _dates2.default.isJustDate(eEnd) || !showMultiDayTimes && !_dates2.default.eq(eStart, eEnd, 'day')) {
    ...
    return _react2.default.createElement(
      'div',
      {
        className: (0, _classnames2.default)('rbc-time-view', resources && 'rbc-time-view-resources')
      },
