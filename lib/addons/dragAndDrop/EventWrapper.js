...
var EventWrapper = function (_React$Component) {
  ...
  function EventWrapper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleResizeUp = function (e) {
  ...
  EventWrapper.prototype.renderAnchor = function renderAnchor(direction) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement('div', { className: 'rbc-addons-dnd-resize-' + cls + '-icon' })
    );
  };
