  ...
  return (0, _memoizeOne2.default)(function (options) {
    ...
    while (levels.length < minRows) {
      ...
      continuesAfter: function continuesAfter(event) {
        ...
        var singleDayDuration = _dates2.default.eq(accessors.start(event), eventEnd, 'minutes');

        return singleDayDuration ? _dates2.default.gte(eventEnd, last, 'minutes') : _dates2.default.gt(eventEnd, last, 'minutes');
      }
    };
  }, isEqual);
}